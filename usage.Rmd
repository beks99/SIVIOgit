...
success_loan$success_loan_value = rowMeans(success_loan[, c("success_12months", "success_4years")])
...
service_loan$service_loan_value = rowMeans(service_loan[, c("service_12months", "service_4years")])
...
```{r echo=FALSE}
formal_loan = data %>% select(all_of(level),
                other_finance_institutions, 
