...
This section consists of **20** criteria
...
availability_critera$availability_normalise = (availability_critera$availability_score / 20)
...
```{r}
write.csv(availability_critera, file = "~/SIVIO/availability_criteria.csv")
```
