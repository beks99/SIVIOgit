...
```{r}
read_completedata = read.csv(file = '~/SIVIO/9_11_2021_complete.csv',
                          header = T, sep = ',')
```
...
```{r}
write.csv(survey_completedata, file = "~/SIVIO/survey_financial_inclusion.csv")

write.csv(clean_completedata, file = "~/SIVIO/clean_financial_inclusion.csv")
```
