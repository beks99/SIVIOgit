...
This involved fixing codes and enumerator name: 
...
And then collapse the other columns.... this is still a debated stage as this interfers with grouping
...
```{r}
read_completedata = read.csv(file = '~/SIVIOgit/12_11_2021_complete.csv',
                          header = T, sep = ',')
```
...
```{r}
write.csv(survey_completedata, file = "~/SIVIOgit/survey_FI_2021.csv")

write.csv(clean_completedata, file = "~/SIVIOgit/clean_FI_2021.csv")
```
